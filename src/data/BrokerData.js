...
const brokerProfilePT = {
  ...
  description: {
    ...
    paragraph: [
      'Formação inicial na área metal mecânica, mudei para Florianópolis, onde me apaixonei pela Ilha e iniciei carreira no setor Hoteleiro e Imobiliário por mais de 20 anos. Nos últimos anos migrei para a área de venda de imóveis, onde ajudo a realizar sonhos.',
    ],
  },
  address: {
  ...
  phone: '(48) 99154-5128',
  email: 'leonardo@rkimoveis.com.br',
  clientReview: {
    review: '',
    client: '',
  },
...
const brokerProfileES = {
  ...
  description: {
    title:
      '"Soy un padre dedicado, con altos estándares éticos y morales. Me encanta la buena música, trabajar la madera de forma artesanal y mi hobby es vender bienes raíces y hacer sueños realidad!"',
    paragraph: [
      'Con formación inicial en el área de metalmecánica, me mudé a Florianópolis, donde me enamoré de la Isla y comencé una carrera en el sector Hotelero e Inmobiliario por más de 20 años. En los últimos años migré al área de venta de propiedades, donde ayudo a hacer realidad los sueños.',
    ],
  },
  address: {
    street: 'Rua das Gaivotas',
